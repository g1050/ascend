...
struct Node2
{
    ...
    // Node的输出是中间tensor类型
    atb::SVector<TensorType2> outTensorTypes_{};
...
public:
     ...
     */
    explicit Model2(std::string &&modelName = "") : modelName_(std::move(modelName))
    {
...
private:
    ...
    std::vector<Node2> nodes_;                 // 节点集合，组成完整的计算图
